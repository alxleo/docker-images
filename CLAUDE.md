...
SOPS-encrypted files, .env files, or anything from the private private repositories repo
that isn't a Dockerfile or entrypoint script.

This repo contains ONLY: Dockerfiles, entrypoint scripts, build configs, and CI workflows.
